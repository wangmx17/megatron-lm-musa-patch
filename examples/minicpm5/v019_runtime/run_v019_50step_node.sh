...
RUN_ROOT=${ROOT}/v019_compat_50step_20260915/${V019_ATTEMPT:-preflight}
mkdir -p "${RUN_ROOT}"
...
export TRAIN_ITERS=50 LR_WARMUP_ITERS=1000 SAVE_INTERVAL=999999
...
bash ${ROOT}/train_16a3b_v019_isolated.sh "${RUN_ROOT}" "${PATCH}" \
  ...
  2 1 1 32 ${ROOT}/models/ckpt v019_50step_${V019_ATTEMPT:-preflight} 30629
