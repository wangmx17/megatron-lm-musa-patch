...
# Default MoE capacity_factor=1.0 with probs drop. Unset MOE_EXPERT_CAPACITY_FACTOR for dropless.
export MOE_EXPERT_CAPACITY_FACTOR=${MOE_EXPERT_CAPACITY_FACTOR:-1.0}
export MOE_TOKEN_DROP_POLICY=${MOE_TOKEN_DROP_POLICY:-probs}
...
MOE_EXPERT_CAPACITY_FACTOR: ${MOE_EXPERT_CAPACITY_FACTOR:-unset}
MOE_TOKEN_DROP_POLICY:  ${MOE_TOKEN_DROP_POLICY:-unset}
