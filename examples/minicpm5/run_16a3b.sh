...
export NVTE_MUSA_THD_BWD_READ_HALF_FUSION=${NVTE_MUSA_THD_BWD_READ_HALF_FUSION:-0}
...
NVTE_MUSA_THD_BWD_READ_HALF_FUSION: ${NVTE_MUSA_THD_BWD_READ_HALF_FUSION:-unset}
...
NVTE_MUSA_THD_BWD_READ_HALF_FUSION='${NVTE_MUSA_THD_BWD_READ_HALF_FUSION:-0}' \
