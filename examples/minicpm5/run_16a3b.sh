...
# Default MoE capacity_factor=0.8 with probs drop. Unset MOE_EXPERT_CAPACITY_FACTOR for dropless.
export MOE_EXPERT_CAPACITY_FACTOR=${MOE_EXPERT_CAPACITY_FACTOR:-0.8}
